    ...
    * @returns {@link FormKitSchemaExtendableSection | FormKitSchemaExtendableSection}
     ...
     * @returns {@link FormKitSchemaExtendableSection | FormKitSchemaExtendableSection}
      ...
      * @returns {@link @formkit/core#FormKitPlugin | FormKitPlugin}
       ...
       * @public
       */
      export declare function eachSection<T>(schema: FormKitSchemaDefinition, callback: (section: FormKitSchemaComponent | FormKitSchemaDOMNode, schemaParent: FormKitSchemaNode[], schema: FormKitSchemaCondition) => T, stopOnCallbackReturn?: boolean, schemaParent?: FormKitSchemaNode[]): T | void;
       ...
       * @returns {@link @formkit/core#FormKitSchemaNode | FormKitSchemaNode}
        ...
        * @public
        */
       export declare function findSection(schema: FormKitSchemaDefinition, target: string): [false, false] | [FormKitSchemaNode[] | false, FormKitSchemaCondition];
