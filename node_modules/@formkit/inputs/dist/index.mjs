...
function useSchema(inputSection) {
    return /* #__PURE__ */ outer(/* #__PURE__ */ wrapper(/* #__PURE__ */ label('$label'), /* #__PURE__ */ inner(/* #__PURE__ */ prefix(), inputSection(), /* #__PURE__ */ suffix())), /* #__PURE__ */ help('$help'), /* #__PURE__ */ messages(/* #__PURE__ */ message('$message.value')));
}
// ========================================================
/**
...
const select = {
     ...
     * The actual schema of the input, or a function that returns the schema.
     */
    schema: /* #__PURE__ */ outer(/* #__PURE__ */ wrapper(/* #__PURE__ */ label('$label'), /* #__PURE__ */ inner(/* #__PURE__ */ icon('prefix'), /* #__PURE__ */ prefix(), /* #__PURE__ */ selectInput$1(/* #__PURE__ */ $if('$slots.default', () => '$slots.default', /* #__PURE__ */ $if('$slots.option', optionSlot, /* #__PURE__ */ option('$option.label')))), /* #__PURE__ */ $if('$attrs.multiple !== undefined', () => '', /* #__PURE__ */ icon('select')), /* #__PURE__ */ suffix(), /* #__PURE__ */ icon('suffix'))), /* #__PURE__ */ help('$help'), /* #__PURE__ */ messages(/* #__PURE__ */ message('$message.value'))),
    /**
     * The type of node, can be a list, group, or input.
     */
    type: 'input',
